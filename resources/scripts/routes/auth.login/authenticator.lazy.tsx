...
export const Route = createLazyFileRoute('/auth/login/authenticator')({
        ...
        <form onSubmit={form.handleSubmit(submit)}>
          <CardContent>
            {type === 'code' ? (
              ...
              <>
                <InputForm name={'recoveryCode'} label={'Recovery Code'} />
              </>
            )}
          </CardContent>
          ...
          <CardFooter className={'flex flex-col justify-end gap-2 sm:flex-row'}>
            {type === 'code' ? (
              <Button
                ...
                variant={'ghost'}
                onClick={() => form.setValue('type', 'recovery')}
              >
            ...
            {type === 'recovery' && (
              <FormButton className={'max-sm:w-full'}>Continue</FormButton>
            )}
          </CardFooter>
        </form>
      </Form>
