...
const IconBrandRockyLinux = forwardRef<SVGSVGElement, Props>((props, ref) => {
    return (
...
IconBrandRockyLinux.displayName = 'IconBrandRockyLinux';

export default IconBrandRockyLinux;
