...
const IconBrandAlpineLinux = forwardRef<SVGSVGElement, Props>((props, ref) => {
    return (
        <svg
            ref={ref}
            viewBox='0 0 24 24'
...
IconBrandAlpineLinux.displayName = 'IconBrandAlpineLinux'

export default IconBrandAlpineLinux
