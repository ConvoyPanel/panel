...
const UserServersContainer = () => {
    const userId = AdminUserContext.useStoreState(state => state.user.data!.id)
    const [open, setOpen] = useState(false)

    return (
        <div className='bg-background min-h-screen'>
            <CreateServerModal userId={userId} open={open} onClose={() => setOpen(false)} />
